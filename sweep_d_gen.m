function sweep_d_gen(nu,theta,dlist,hole,perturb,perturbnear,Ush)
% dlist=30:10:300;
V1={};
V2={};
energylist={};   
...
save(sprintf('phase%d,%d_theta%0.2f_h%d_d%d,%d_U%d.mat',nu(1),nu(2),theta,hole,dlist(1),dlist(end),Ush),'V1','V2','energylist','dlist');
end
