parameters=mainTMD_2('m',0.45,'psi',-0.3329/(2*pi)*360,'V',4.428,'w',20,'theta',4,'nu',[1,3],...
...
%     'd',inf,'s',inf,'Vz',0,'Ez',0,'hole',1,'perturb',0,'perturbnear',[1,3],'T',0e-3);
tshell=3;
% tshell=1;
...
% t=cellfun(@(x) mean(x)*zeros(1,length(x)),t,'UniformOutput',false);
