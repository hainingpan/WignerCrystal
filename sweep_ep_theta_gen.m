...
function sweep_ep_theta_gen(nu,epsilonlist,thetalist)
...
save(sprintf('phase%d,%d_theta(%0.2f,%0.2f,%d).mat',nu(1),nu(2),thetalist(1),thetalist(end),Ntheta),'V1','V2','energylist','t','U');
end
